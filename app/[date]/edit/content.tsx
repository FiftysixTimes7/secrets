...
export default function Content({ defaultContent, handleSave, handleDelete }: { defaultContent: string, handleSave: Function, handleDelete: Function }) {
    function makeHandle(handle: Function) {
        function ret() {
    ...
    return <div className='flex flex-col items-center'>
        ...
        <div className='flex justify-center'>
            ...
            <button className="flex justify-center p-2 pl-2.5 pb-2.5 transition fill-red-800 hover:fill-red-500" onClick={makeHandle(handleDelete)}>
                <svg xmlns="http://www.w3.org/2000/svg" height="25" width="25" viewBox="0 0 448 512">
                    {/* <!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--> */}
